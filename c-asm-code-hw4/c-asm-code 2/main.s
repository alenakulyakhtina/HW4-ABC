...
# main.c:5: {
	movl	$40, %ebx	#, tmp83
	movq	%fs:(%rbx), %rax	# MEM[(<address-space-1> long unsigned int *)40B], tmp87
	movq	%rax, 6408(%rsp)	# tmp87, D.2572
	xorl	%eax, %eax	# tmp87
# main.c:7:   list[0] = ani_random_animal();
	movq	%rsp, %rdi	#, tmp84
...
# /usr/include/x86_64-linux-gnu/bits/stdio2.h:107:   return __printf_chk (__USE_FORTIFY_LEVEL - 1, __fmt, __va_arg_pack ());
	...
	call	puts@PLT	#
# main.c:11: }
	movq	6408(%rsp), %rax	# D.2572, tmp88
	xorq	%fs:(%rbx), %rax	# MEM[(<address-space-1> long unsigned int *)40B], tmp88
	jne	.L4	#,
	movl	$0, %eax	#,
	addq	$6416, %rsp	#,
	.cfi_remember_state
